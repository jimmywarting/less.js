...
(function (global, factory) {
  ...
  const addDefaultOptions = function (window, options) {
  ...
  const data = { colors, unitConversions }
  ...
  Color.prototype = Object.assign(new Node(), {
    type: 'Color',
    luma: function () {
      let r = this.rgb[0] / 255; let g = this.rgb[1] / 255; let b = this.rgb[2] / 255
    ...
    toHSL: function () {
      const r = this.rgb[0] / 255; const g = this.rgb[1] / 255; const b = this.rgb[2] / 255; const a = this.alpha
  ...
  function copy (target, options) {
    ...
    if (isArray(target)) { return target.map(function (i) { return copy(i, options) }) }
  ...
  Selector.prototype = Object.assign(new Node(), {
    ...
    createEmptySelectors: function () {
      const el = new Element('', '&', false, this._index, this._fileInfo); const sels = [new Selector([el], null, null, this._index, this._fileInfo)]
  ...
  Declaration.prototype = Object.assign(new Node(), {
    ...
    eval: function (context) {
      let mathBypass = false; let prevMath; let name = this.name; let evaldValue; let variable = this.variable
  ...
  const functionRegistry = makeRegistry(null)
    ...
    properties: function () {
      if (!this._properties) {
        this._properties = !this.rules ? {} : this.rules.reduce(function (hash, r) {
          if (r instanceof Declaration && r.variable !== true) {
            const name_2 = (r.name.length === 1) && (r.name[0] instanceof Keyword)
              ? r.name[0].value
              : r.name
  ...
  Operation.prototype = Object.assign(new Node(), {
    ...
    eval: function (context) {
      let a = this.operands[0].eval(context); let b = this.operands[1].eval(context); let op
  ...
  const functionCaller = /** @class */ (function () {
    ...
    functionCaller.prototype.call = function (args) {
      ...
      const commentFilter = function (item) { return !(item.type === 'Comment') }
  ...
  Call.prototype = Object.assign(new Node(), {
    ...
    eval: function (context) {
      ...
      const args = this.args.map(function (a) { return a.eval(context) })
      exitCalc()
  ...
  Extend.prototype = Object.assign(new Node(), {
    ...
    findSelfSelectors: function (selectors) {
      let selfElements = []; let i; let selectorElements
  ...
  NamespaceValue.prototype = Object.assign(new Node(), {
    type: 'NamespaceValue',
    eval: function (context) {
      let i; let name; let rules = this.value.eval(context)
  ...
  const AbstractFileManager = /** @class */ (function () {
  ...
  const AbstractPluginLoader = /** @class */ (function () {
  ...
  const ImportSequencer = /** @class */ (function () {
    ...
    ImportSequencer.prototype.addImport = function (callback) {
      const importSequencer = this; const importItem = {
        callback,
        args: null,
        isReady: false
      }
  ...
  ImportVisitor.prototype = {
    ...
    processImportNode: function (importNode, context, importParent) {
      ...
      if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
        ...
        const onImported = this.onImported.bind(this, evaldImportNode, context); const sequencedOnImported = this._sequencer.addImport(onImported)
    ...
    onImported: function (importNode, context, e, root, importedAtRoot, fullPath) {
      ...
      const importVisitor = this; const inlineCSS = importNode.options.inline; const isPlugin = importNode.options.isPlugin; const isOptional = importNode.options.optional; const duplicateImport = importedAtRoot || fullPath in importVisitor.recursionDetector
  ...
  const SetTreeVisibilityVisitor = /** @class */ (function () {
  ...
  /* jshint loopfunc:true */
  const ExtendFinderVisitor = /** @class */ (function () {
    ...
    ExtendFinderVisitor.prototype.visitRuleset = function (rulesetNode, visitArgs) {
      ...
      for (i = 0; i < paths.length; i++) {
        const selectorPath = paths[i]; const selector = selectorPath[selectorPath.length - 1]; const selExtendList = selector.extendList
  ...
  const ProcessExtendsVisitor = /** @class */ (function () {
    ...
    ProcessExtendsVisitor.prototype.extendSelector = function (matches, selectorPath, replacementSelector, isVisible) {
      ...
      let currentSelectorPathIndex = 0; let currentSelectorPathElementIndex = 0; let path = []; let matchIndex; let selector; let firstElement; let match; let newElements
  ...
  const JoinSelectorVisitor = /** @class */ (function () {
  ...
  const CSSVisitorUtils = /** @class */ (function () {
  ...
  ToCSSVisitor.prototype = {
    ...
    _mergeRules: function (rules) {
      ...
      groupsArr.forEach(function (group) {
        if (group.length > 0) {
          const result_1 = group[0]
          let space_1 = []
          const comma_1 = [new tree.Expression(space_1)]
        ...
        entities: {
          ...
          url: function () {
            ...
            return new (tree.URL)((value.value != null ||
              ...
              ? value
              : new (tree.Anonymous)(value, index), index, fileInfo)
          },
          //
  ...
  const boolean$1 = { isdefined, boolean, if: If }
  ...
  colorFunctions = {
    ...
    rgba: function (r, g, b, a) {
      try {
        ...
        const rgb = [r, g, b].map(function (c) { return scaled(c, 255) })
        a = number$1(a)
  ...
  for (const f$1 in colorBlendModeFunctions) {
    if (colorBlendModeFunctions.hasOwnProperty(f$1)) {
      colorBlend[f$1] = colorBlend.bind(null, colorBlendModeFunctions[f$1])
    }
  }

  const dataUri = function (environment) {
    const fallback = function (functionThis, node) { return new URL(node, functionThis.index, functionThis.currentFileInfo).eval(functionThis.context) }
    return {
  ...
  const MathHelper = function (fn, unit, n) {
    if (!(n instanceof Dimension)) {
  ...
  const number = {
    ...
    percentage: function (n) {
      const result = MathHelper(function (num) { return num * 100 }, '%', n)
      return result
    }
  }
  ...
  const svg = function (environment) {
    return {
  ...
  const isa = function (n, Type) { return (n instanceof Type) ? Keyword.True : Keyword.False }
  ...
  const functions = function (environment) {
  ...
  /**
     * Plugin Manager
     */
  const PluginManager = /** @class */ (function () {
  ...
  function SourceMapOutput (environment) {
    const SourceMapOutput = /** @class */ (function () {
  ...
  function SourceMapBuilder (SourceMapOutput, environment) {
    const SourceMapBuilder = /** @class */ (function () {
  ...
  function ParseTree (SourceMapBuilder) {
    const ParseTree = /** @class */ (function () {
  ...
  function ImportManager (environment) {
    ...
    const ImportManager = /** @class */ (function () {
      ...
      ImportManager.prototype.push = function (path, tryAppendExtension, currentFileInfo, importOptions, callback) {
        const importManager = this; const pluginLoader = this.context.pluginManager.Loader
  ...
  function Parse (environment, ParseTree, ImportManager) {
    var parse = function (input, options, callback) {
      ...
      if (!callback) {
        ...
        const pluginManager_1 = new PluginManagerFactory(this, !options.reUsePluginManager)
        ...
        const imports_1 = new ImportManager(this, context_1, rootFileInfo)
  ...
  const parseNodeVersion_1 = parseNodeVersion
  ...
  const LogListener = function (less, options) {
  ...
  const ErrorReporting = function (window, less, options) {
  ...
  const Cache = function (window, options, logger) {
    let cache = null
    if (options.env !== 'development') {
      try {
  ...
  //
  const root = function (window, options) {
    const document = window.document
    const less = lessRoot()
